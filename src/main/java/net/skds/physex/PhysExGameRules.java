...
public class PhysExGameRules {
	...
	public static final GameRules.Key<GameRules.BooleanValue> DESTROY_NOT_DISPLACED_FLUIDS =
			createFluidGamerule("DestroyNotDisplacedFluids", GameRuleFactory.createBooleanRule(false));

	public static final GameRules.Key<GameRules.BooleanValue> BLOCK_PISTONS =
			createFluidGamerule("BlockPistons", GameRuleFactory.createBooleanRule(true));
